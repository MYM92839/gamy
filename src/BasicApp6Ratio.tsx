    ...
    navigator.mediaDevices
      .getUserMedia({
        video: {
          ...
          advanced: [{ zoom: 1.6 } as any], // 1/1.5 줌 (지원하는 기기에서만 작동)
        },
        audio: false,
      })
      .then((stream) => {
...
function UIOverlayIOS({
  ...
  const getPosition = () => {
    ...
    if (saved) {
      const base = char === 'moons' ? 'https://gamy-six.vercel.app/r' : 'https://gamy-six.vercel.app/tree';
      ...
      <button
        ...
        onClick={() => {
          window.location.href =
            char === 'moons' ? 'https://gamy-six.vercel.app/r' : 'https://gamy-six.vercel.app/tree';
        }}
      >
        <Back />
      </button>
